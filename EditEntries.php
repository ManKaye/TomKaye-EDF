    ...
    <body>
        <?php
            if($_POST["Edit-Entry"]){
                ...
                echo "<input type='text' class='Task-Entry' name='Appended-Entry'><input type='submit' name='Submit-Edit' value='Submit the Appended Entry'><input type='hidden' name='Log' value='".$entry."'></form>";
                echo "</div>";
            }
